...
# preconditions:  The array would take in the fixed size as an argument
# postconditions: The output would come up as all the elements are printed
#                 in an array one after other and seperated by comma and
...
#   count and array(list of elements)

# preconditions:  The array counts the number of items and takes buildarray 
...
# Testing algorithm to print the list
